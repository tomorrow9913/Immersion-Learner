...
const mockTextItems: TextItem[] = [
  { str: 'This is the first sentence. ', dir: 'ltr', width: 100, height: 20, transform: [1, 0, 0, 1, 10, 10], fontName: 'g_d0_f1', hasEOL: true },
  { str: 'This is the second sentence!', dir: 'ltr', width: 100, height: 20, transform: [1, 0, 0, 1, 10, 40], fontName: 'g_d0_f1', hasEOL: true },
];
